...
\begin{definition}[Partial ordering]\label{De:PartialOrder}
...
\begin{definition}[Linear ordering]\label{De:LinearOrder}
...
\begin{definition}[Well ordering]\label{De:WellOrdering}
...
\begin{definition}[Topologies]\label{De:Topology}
...
\begin{definition}[Axioms of countability]\label{De:AxiomsOfCountability}
	Let $(X,\tau)$ be a topological space.
	\begin{itemize}
...
\begin{definition}[Metrics]\label{De:Metrics}
...
\begin{definition}[Quotient metric spaces]\label{De:QuotientMetricSpaces}
	...
	Then $(Y,d)$ with $Y \coloneqq X / {\sim}$ and $d([x],[y]) \coloneqq \rho(x,y)$ is a metric space.
\end{definition}

\section{Normed Spaces}

\begin{definition}[Infinite sums]\label{De:InifiniteSums}
...
\begin{definition}[Norms]\label{De:Norms}
...
\begin{definition}[$\ell^p$ spaces]\label{De:lpSpaces}
